...
<head>
  ...
  <title>Wäsche & Bügelservice</title>

  <!-- Einheitlicher Stil + Schriftart -->
...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Wäsche & Bügelservice</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="HaushaltWohnen-WaescheBuegelservice" />

      <textarea name="message" class="textarea-box" placeholder="Beschreibe Dein Anliegen zur Wäsche oder zum Bügelservice."></textarea>
