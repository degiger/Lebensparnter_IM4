...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Gartenpflege</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="HaushaltWohnen-Gartenpflege" />

      <textarea name="message" class="textarea-box" placeholder="Beschreibe Dein Anliegen zur Gartenpflege."></textarea>
