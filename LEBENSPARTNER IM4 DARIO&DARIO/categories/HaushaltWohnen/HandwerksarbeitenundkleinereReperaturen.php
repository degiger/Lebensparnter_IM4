...
<head>
  ...
  <title>Handwerksarbeiten & kleinere Reparaturen</title>

  <!-- Einheitliches CSS & Schrift -->
...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Handwerksarbeiten & kleinere Reparaturen</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="HaushaltWohnen-HandwerksarbeitenReparaturen" />

      <textarea name="message" class="textarea-box" placeholder="Beschreibe Dein Anliegen zur Reparatur oder zum Handwerk."></textarea>
