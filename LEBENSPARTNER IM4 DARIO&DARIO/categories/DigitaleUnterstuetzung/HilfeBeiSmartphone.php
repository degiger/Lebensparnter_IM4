...
<head>
  ...
  <title>Hilfe bei Smartphone, Tablet, PC</title>
...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Hilfe bei Smartphone, Tablet, PC</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="HaushaltWohnen-SupportSmartphoneTabletPC" />

      <textarea name="message" class="textarea-box" placeholder="Beschreibe Dein Problem mit Deinem Gerät."></textarea>

      <p class="info-text">
        Die zuständige Stelle wird sich innerhalb von 24 Stunden bei Dir melden.
      </p>
