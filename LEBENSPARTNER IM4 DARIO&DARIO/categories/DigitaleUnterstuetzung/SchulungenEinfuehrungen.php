...
<head>
  ...
  <title>Schulungen & Einführungen</title>
...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Schulungen & Einführungen</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="HaushaltWohnen-SchulungenEinfuehrungen" />

      <textarea name="message" class="textarea-box" placeholder="Wobei brauchst Du eine Schulung oder Einführung?"></textarea>
