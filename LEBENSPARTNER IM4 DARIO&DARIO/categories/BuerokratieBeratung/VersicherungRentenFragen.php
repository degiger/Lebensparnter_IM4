...
<head>
  ...
  <title>Versicherungs- & Rentenfragen</title>
...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Versicherungs- & Rentenfragen</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="Beratung-VersicherungRente" />

      <textarea name="message" class="textarea-box" placeholder="Welche Fragen oder Anliegen hast Du zu Renten oder Versicherungen?"></textarea>

      <p class="info-text">
        Unsere Partner unterstützen Dich innerhalb von 24 Stunden zu Deinen Anliegen.
      </p>
