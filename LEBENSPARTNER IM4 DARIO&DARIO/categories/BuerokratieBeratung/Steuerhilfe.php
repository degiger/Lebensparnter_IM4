...
<body>
  ...
  <main class="login-container">
    <h1 class="login-title">Steuerhilfe</h1>

    <form method="POST" class="login-form">
      <input type="hidden" name="type" value="Beratung-Steuerhilfe" />

      <textarea name="message" class="textarea-box" placeholder="Wobei brauchst Du Unterstützung bei der Steuererklärung oder Steuerfragen?"></textarea>
